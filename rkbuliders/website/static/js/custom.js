        ...
        submitHandler: function(form) {
	                        $.ajax({
	                            ...
	                            beforeSend: function(jqXhr){
	                                $(form).find('.quform-success-message').css('display', 'none');
	                                $(form).find('.quform-loading-wrap').show();
	                                $(form).find('.quform-submit-inner button').prop('disabled', true);
	                            },
	                            success: function(res){

	                                $(form)[0].reset();
	                                $(form).find('.quform-success-message').show().fadeOut(4000);

	                            },
	                            complete: function(jqxhr, textStatus){
                                    $(form).find('.quform-loading-wrap').hide();
                                    $(form).find('.quform-submit-inner button').prop('disabled', false);
	                            }
	                        });
				       }
